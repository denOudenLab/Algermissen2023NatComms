...
% bad co-registration: 15 25
% bad pre-processing: 11 12 23 30 (03?, 35?)
% additional outliers in TAfT: 26
...
if ~isfield(job, 'invalidSubs')
    ...
    % job.invalidSubs = [11 12 23 30]; % subjects exlcuded for EEG --> FOR UPDATESTD AND UPDATEDIF
