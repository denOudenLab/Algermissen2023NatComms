function EEGfMRIPav_OutcomeLocked_5_TR(rootDir, iSub)

% EEGfMRIPav_OutcomeLocked_5_TR(rootDir, iSub)
% 
% Interactive script.
% Visualize trials with EEGlab, identify trials to reject via visual
% inspection. 
% Mind setting your own EEGlab directory!
% 
% INPUTS:
...
inputFile       = fullfile(dirs.postICA, fileList{subIndex}); % go to subject directory
...
for iTrial = 1:EEG.trials
    EEG.data(:, :, iTrial) = data.trial{iTrial};
end
