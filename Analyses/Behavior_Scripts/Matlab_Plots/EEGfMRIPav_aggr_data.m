...
%% 00c) Initialize output fields as NaN:
...
for iSub = 1:nSub % iSub = 1;
    ...
    % ------------------------------------------------------------------- %
    %% 02) Concatenate both sessions (blocks 1-3 and 4-6):
    ...
    % ------------------------------------------------------------------- %
    %% 03) Carry forward conditions and outcomes:
    ...
    % ------------------------------------------------------------------- %
    %% 04) Recode responses and accuracy:
...
%     [dat.valence dat.fb.abs dat.fb.rel dat.fb.all] % check valence, abs, rel, all
    ...
    % ------------------------------------------------------------------- %
    %% 06) Determine win stay/ lose stay behavior (after previous recoding): 
    ...
    % ---------------------------------------------------------------------
    %% 08) Save stimulus order per subject:
    ...
    % ------------------------------------------------------------------- %
    %% 09) Sort choices/ accuracy/ RTs per cue:
    ...
    % ------------------------------------------------------------------- %
    %% 10) Aggregate choices/ accuracy/ RT per CONDITION:
    ...
    % ------------------------------------------------------------------- %
    %% 11) RTs: correct Go, incorrect Go (other Go), incorrect Go (NoGo):
    ...
    % ------------------------------------------------------------------- %
    %% 12) Win-stay/ lose stay (without Go):
    ...
    % ------------------------------------------------------------------- %
    %% 13) Win-stay/ lose stay separate for Go/NoGo:
...
% ----------------------------------------------------------------------- %
%% 14) Save as csv, but also return as function argument:
