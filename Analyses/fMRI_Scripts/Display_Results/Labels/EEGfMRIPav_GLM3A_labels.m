% EEGfMRIPav_GLM3A_labels.m

% Create labels for each contrast of GLM3A.
%
...
GLMlabels = {
                ...
                6, 'Frontal theta', '\beta_{Frontal Theta} (a.u.)', 'pos';
                };
rootDir     = '/project/3017042.02';
fileName    = fullfile(rootDir, 'Analyses/fMRI_Scripts/Display_Results/Labels/GLM3Alabels.mat');
