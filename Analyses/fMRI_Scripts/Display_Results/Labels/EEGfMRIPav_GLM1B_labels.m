% EEGfMRIPav_GLM1B_labels.m

% Create labels for each contrast of GLM1B.
%
...
fileName    = fullfile(rootDir, 'Analyses/fMRI_Scripts/Display_Results/Labels/GLM1Blabels.mat');
