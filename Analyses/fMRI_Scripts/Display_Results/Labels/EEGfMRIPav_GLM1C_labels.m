% EEGfMRIPav_GLM1C_labels.m

% Create labels for each contrast of GLM1C.
%
...
fileName    = fullfile(rootDir, 'Analyses/fMRI_Scripts/Display_Results/Labels/GLM1Clabels.mat');
