...
% Plots for Supplementary Figure S07.
% The same approach is used for Figure 2 and Supplementary Figures S01, S06. 
%
...
% Execute for left-most-column (column 1).
...
% Execute for other columns (columns 2-5).
% Select model 5, 7, 8, or 9.

% Set model:
iMod        = 5; % columns 2 % model ID
% iMod        = 7; % columns 3 % model ID
% iMod        = 8; % columns 4 % model ID
% iMod        = 9; % columns 5 % model ID
...
% ----------------------------------------------------------------------- %
% Determine column for saving:

if contains(datType, 'osap') && iMod == 5; iCol = 2; end
if contains(datType, 'osap') && iMod == 7; iCol = 3; end
if contains(datType, 'osap') && iMod == 8; iCol = 4; end
if contains(datType, 'osap') && iMod == 9; iCol = 5; end
fprintf('Save scripts for column %d\n', iCol);

% ======================================================================= %
% ======================================================================= %
% ======================================================================= %
% ======================================================================= %
%% First row: LEARNING CURVES:
...
figName = fullfile(dirs.root, sprintf('Log/OutcomeLockedPaperPlots/FigS07_1%d', iCol));
...
fullFileName = fullfile(dirs.root, sprintf('Log/OutcomeLockedPaperPlots/FigS07_1%d_G2W.csv', iCol));
csvwrite(fullFileName, squeeze(pGoCond(validSubs, 1, :)));
fullFileName = fullfile(dirs.root, sprintf('Log/OutcomeLockedPaperPlots/FigS07_1%d_1G2A.csv', iCol));
csvwrite(fullFileName, squeeze(pGoCond(validSubs, 2, :)));
fullFileName = fullfile(dirs.root, sprintf('Log/OutcomeLockedPaperPlots/FigS07_1%d_NG2W.csv', iCol));
csvwrite(fullFileName, squeeze(pGoCond(validSubs, 3, :)));
fullFileName = fullfile(dirs.root, sprintf('Log/OutcomeLockedPaperPlots/FigS07_1%d_NG2A.csv', iCol));
csvwrite(fullFileName, squeeze(pGoCond(validSubs, 4, :)));

% ======================================================================= %
% ======================================================================= %
% ======================================================================= %
%% Second row: p(Go) BAR PLOTS
...
% Determine figure name:
figName = fullfile(dirs.root, sprintf('Log/OutcomeLockedPaperPlots/FigS07_2%d', iCol));
saveas(gcf, [figName '.png']);
...
% Save source data files:
fullFileName = fullfile(dirs.root, sprintf('Log/OutcomeLockedPaperPlots/FigS07_2%d_pGo.csv', iCol));
csvwrite(fullFileName, pGoCondMean);
fullFileName = fullfile(dirs.root, sprintf('Log/OutcomeLockedPaperPlots/FigS07_2%d_pCorrect.csv', iCol));
csvwrite(fullFileName, pCorrectCondMean);

% ======================================================================= %
% ======================================================================= %
% ======================================================================= %
%% Third row: Win-stay/ lose-stay BAR PLOTS:
...
% Determine figure name:
figName = fullfile(dirs.root, sprintf('Log/OutcomeLockedPaperPlots/FigS07_3%d', iCol));
saveas(gcf, [figName '.png']);
...
% Save source data files:
fullFileName = fullfile(dirs.root, sprintf('Log/OutcomeLockedPaperPlots/FigS07_3%d.csv', iCol));
csvwrite(fullFileName, data(validSubs, condOrder));

% ======================================================================= %
% ======================================================================= %
% ======================================================================= %
%% Fourth row, left panel: LOG MODEL EVIDENCE

% Connect data points of the same subject or not:
addLines    = false;

% Relevant settings:
modVec      = [5 7 8 9]; % asymmetric pathways plus dual perseverance, neutral-outcome reinterpretation model
modNames    = modVec;
...
% ------------------------------------------------------ %
% Save:
figName = fullfile(dirs.root, 'Log/OutcomeLockedPaperPlots/FigS07_41');
saveas(gcf, [figName '.png']);
...
% Save source data files:
fullFileName = fullfile(dirs.root, sprintf('Log/OutcomeLockedPaperPlots/FigS07_41.csv'));
csvwrite(fullFileName, lME(validSubs, :));

% ======================================================================= %
% ======================================================================= %
% ======================================================================= %
%% Fourth row, right panel: MODEL FREQUENCY AND EXCEEDANCE PROBABILITY:

% Select models:
modVec      = [5 7 8 9]; % asymmetric pathways plus single perseverance, dual perseverance, neutral-outcome reinterpretation model
modNames    = modVec;
...
% Save:
figName = fullfile(dirs.root, 'Log/OutcomeLockedPaperPlots/FigS07_42');
saveas(gcf, [figName '.png']);
...
% Save source data files:
fullFileName = fullfile(dirs.root, sprintf('Log/OutcomeLockedPaperPlots/FigS07_42_modFreq.csv'));
csvwrite(fullFileName, modFreq);
fullFileName = fullfile(dirs.root, sprintf('Log/OutcomeLockedPaperPlots/FigS07_42_PXP.csv'));
