...
# Plots for Supplementary Figure S11.
# Just executes ./extract_ROI_HOA_GLM2_SVC.sh and ./extract_ROI_HOA_GLM1_TAfT.sh.
# Similar script as for Supplementary Figure S12.
#
...
./${rootDir}/Analyses/fMRI_Scripts/Run_ROI/Extract_ROIs/extract_ROI_HOA_GLM2_SVC.sh
